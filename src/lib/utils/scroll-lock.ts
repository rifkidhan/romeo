export interface BodyScrollOptions {
	...
	allowTouchMove?: (el: any) => boolean; //eslint-disable-line @typescript-eslint/no-explicit-any
}

interface Lock {
	targetElement: HTMLElement | Element | any; //eslint-disable-line @typescript-eslint/no-explicit-any
